  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-top: 10px;">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown" style="margin-left: -55px;">
       ...
       <li class="nav-item" style="margin-left: -55px;">
        <a class="nav-link" href="<?php echo base_url(); ?>BoforeLogin/contact_before_login">Contact</a>
      </li>
    </ul>
							...
							<div class="col-lg-4 address-grid">
								<div class="row address-info">
									...
									<div class="col-md-9 address-right text-left">
										...
										<p>Email :
											<a href="mailto:example@email.com"> youth_vision@gmail.com</a>
										</p>
									</div>
							...
							<div class="col-lg-4 address-grid">
								<div class="row address-info">
									...
									<div class="col-md-9 address-right text-left">
										...
										<p>+8801755845637, +8801779878139</p>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-6 map">
						<img style="height: 700px;"src="<?php echo base_url('resource/event_all/images/contact.jpg');?>" alt=" " class="img-fluid">
